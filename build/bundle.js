    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$4, 66, 4, 1886);
    			...
    			add_location(img1, file$4, 74, 8, 2101);
    			add_location(div0, file$4, 73, 6, 2087);
    			attr_dev(div1, "class", "card_front svelte-15w3wuo");
    			add_location(div1, file$4, 72, 4, 2056);
    			...
    			add_location(div2, file$4, 61, 2, 1709);
    			...
    			add_location(card_1, file$4, 60, 0, 1607);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
