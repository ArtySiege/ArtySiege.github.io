...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$4, 82, 4, 2388);
    			...
    			add_location(img1, file$4, 90, 8, 2603);
    			add_location(div0, file$4, 89, 6, 2589);
    			attr_dev(div1, "class", "card_front svelte-15w3wuo");
    			add_location(div1, file$4, 88, 4, 2558);
    			...
    			add_location(div2, file$4, 77, 2, 2211);
    			...
    			add_location(card_1, file$4, 76, 0, 2109);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, prefersReducedMotion, $$value => $$invalidate(18, $prefersReducedMotion = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
